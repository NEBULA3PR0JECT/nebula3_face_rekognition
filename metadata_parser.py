...
def main():
    ...
    imdb_mat = '/notebooks/nebula3_face_rekognition/imdb_crop/imdb.mat'
    wiki_mat = '/notebooks/nebula3_face_rekognition/wiki_crop/wiki.mat'
    ...
    imdb_celeb_name = imdb[0][0][8][0]
    imdb_celeb_id = imdb[0][0][9][0]
    ...
    final_imdb = np.vstack((imdb_age, imdb_genders, imdb_path, imdb_face_score1, imdb_face_score2, imdb_name, imdb_celeb_id)).T
    final_wiki = np.vstack((wiki_age, wiki_genders, wiki_path, wiki_face_score1, wiki_face_score2, wiki_name)).T
    ...
    final_imdb_df.to_csv('meta.csv', index=False)
